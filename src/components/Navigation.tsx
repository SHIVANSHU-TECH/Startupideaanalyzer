...
export default function Navigation() {
  ...
  const navigationItems = [
    ...
    { name: 'Submitted Ideas', href: '/ideas', icon: (
      <svg fill="currentColor" height="24px" viewBox="0 0 256 256" width="24px" xmlns="http://www.w3.org/2000/svg">
    ...
    { name: 'Saved Reports', href: '/reports', icon: (
      <svg fill="currentColor" height="24px" viewBox="0 0 256 256" width="24px" xmlns="http://www.w3.org/2000/svg">
    ...
    { name: 'Analytics', href: '/analytics', icon: (
      <svg fill="currentColor" height="24px" viewBox="0 0 256 256" width="24px" xmlns="http://www.w3.org/2000/svg">
        <path d="M216,40H136V24a8,8,0,0,0-16,0V40H40A16,16,0,0,0,24,56V176a16,16,0,0,0,16,16H79.36L57.75,219a8,8,0,0,0,12.50,10l29.59-37h56.32l29.59,37a8,8,0,1,0,12.50-10l-21.61-27H216a16,16,0,0,0,16-16V56A16,16,0,0,0,216,40Zm0,136H40V56H216V176ZM104,120v24a8,8,0,0,1-16,0V120a8,8,0,0,1,16,0Zm32-16v40a8,8,0,0,1-16,0V104a8,8,0,0,1,16,0Zm32-16v56a8,8,0,0,1-16,0V88a8,8,0,0,1,16,0Z"></path>
      </svg>
    ) },
  ...
  return (
    <>
      ...
      {/* Sidebar Navigation */}
      <div className={`
        fixed inset-y-0 left-0 z-40 w-80 bg-gray-900 text-white p-6 flex flex-col justify-between
      ...
      `}>
        ...
        <div className="flex flex-col gap-2">
          ...
          <button className="flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-gray-700 transition-colors text-red-400">
